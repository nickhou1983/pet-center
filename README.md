...
### 🧩 模块清单
- [x] [#1 [M1] 基础设施与项目脚手架 · `P0`](../../issues/1)
- [x] [#2 [M2] 数据层与数据模型 · `P0`](../../issues/2)
- [x] [#3 [M3] AI 向量服务（CLIP） · `P0`](../../issues/3)
- [x] [#4 [M4] 图片存储服务 · `P1`](../../issues/4)
- [x] [#5 [M5] 发布模块 · `P0`](../../issues/5)
- [x] [#6 [M6] 混合搜索模块 · `P0`](../../issues/6)
- [ ] [#7 [M7] 浏览与展示模块 · `P1`](../../issues/7)
- [ ] [#8 [M8] 数据初始化与文档收尾 · `P2`](../../issues/8)
...
| 模块 | 依赖 | 被依赖 | 优先级 | 可并行 |
|------|------|--------|--------|--------|
| [#1 基础设施](../../issues/1) | — | [#2](../../issues/2) [#3](../../issues/3) [#4](../../issues/4) | P0 | 起点 |
| [#2 数据层](../../issues/2) | [#1](../../issues/1) | [#5](../../issues/5) [#6](../../issues/6) [#7](../../issues/7) | P0 | 与 [#3](../../issues/3) [#4](../../issues/4) 并行 |
| [#3 AI 向量服务](../../issues/3) | [#1](../../issues/1) | [#5](../../issues/5) [#6](../../issues/6) | P0 | 与 [#2](../../issues/2) [#4](../../issues/4) 并行 |
| [#4 图片存储](../../issues/4) | [#1](../../issues/1) | [#5](../../issues/5) | P1 | 与 [#2](../../issues/2) [#3](../../issues/3) 并行 |
| [#5 发布模块](../../issues/5) | [#2](../../issues/2) [#3](../../issues/3) [#4](../../issues/4) | [#8](../../issues/8) | P0 | 与 [#6](../../issues/6) 并行 |
| [#6 混合搜索](../../issues/6) | [#2](../../issues/2) [#3](../../issues/3) | [#7](../../issues/7) [#8](../../issues/8) | P0 | 与 [#5](../../issues/5) 并行 |
| [#7 浏览与展示](../../issues/7) | [#2](../../issues/2) [#6](../../issues/6) | [#8](../../issues/8) | P1 | — |
| [#8 数据/文档](../../issues/8) | [#5](../../issues/5) [#6](../../issues/6) [#7](../../issues/7) | — | P2 | 终点 |
